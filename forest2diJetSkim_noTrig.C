...
void forest2diJetSkim_noTrig(int nevt=-1) {
  
  TString trig = "HLT_HIUPCL1SingleEG5NotHF2_v1";
  TString trig2 = "HLT_HIUPCSingleEG5NotHF2Pixel_SingleTrack_v1";
  // or "HLT_HIUPCL1SingleEG5NotHF2_v1"
//void forest2diPhotonSkim_pf_photons_and_jets(int nevt=-1, TString trig = "HLT_HIUPCL1DoubleMuOpenNotHF2_v1" ) {
  ...
  TTree *t = (TTree*)f1->Get("ak5PFJetAnalyzer/t");

  TFile* newfile = new TFile(Form("skimmedFiles/upcDiJetSkim2_PYTHIQ_QCD__TuneCUETP8M1_Dijet30__noptcut.root"),"recreate");
